...
async function main() {
  ...
  const subCatJatoTinta = await prisma.category.create({
    data: {
      name: 'Cartuchos Descartáveis e Tintas',
      slug: slugify('Cartuchos Descartáveis e Tintas'), 
  ...
  const productsInputData = [ // Renomeado para evitar conflito com productsToCreate final
    ...
    { name: '122', brandId: hp.id, categoryId: subCatJatoTinta.id, type: 'RECARGA_JATO_TINTA', description: 'Cartucho descartável de tamanho padrão que pode ser recarregado.', imageUrl: '/images/produtos/122.png' },
    { name: '664', brandId: hp.id, categoryId: subCatJatoTinta.id, type: 'RECARGA_JATO_TINTA', description: 'Cartucho descartável de tamanho padrão que pode ser recarregado.', imageUrl: '/images/produtos/664.png' },
    { name: '662', brandId: hp.id, categoryId: subCatJatoTinta.id, type: 'RECARGA_JATO_TINTA', description: 'Cartucho descartável de tamanho padrão que pode ser recarregado.', imageUrl: '/images/produtos/662.png' },
    { name: '667', brandId: hp.id, categoryId: subCatJatoTinta.id, type: 'RECARGA_JATO_TINTA', description: 'Cartucho descartável de tamanho padrão que pode ser recarregado.', imageUrl: '/images/produtos/667.png' },
    { name: '901', brandId: hp.id, categoryId: subCatJatoTinta.id, type: 'RECARGA_JATO_TINTA', description: 'Cartucho descartável de tamanho padrão que pode ser recarregado.', imageUrl: '/images/produtos/901.png' },
  ...
  // Buscar todos os produtos criados para mapeamento (necessário após a criação)
  ...
  const printerModelsList = [
      // ... (lista de modelos de impressora continua a mesma) ...
  ...
  const compatibilityMap = {
      // ... (compatibilityMap continua o mesmo) ...
