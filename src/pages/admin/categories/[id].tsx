  ...
  return (
    <div className="max-w-2xl mx-auto animate-fade-in-up">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button onClick={handleDelete} disabled={isDeleting} className="text-red-600 hover:bg-red-50 px-4 py-2 rounded flex items-center gap-2"><FaTrash /> {isDeleting ? 'Excluindo...' : 'Excluir'}</button>
      </div>
