...
const FAQPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Sim, realizamos entregas em toda a região de Itaquaquecetuba e arredores. Consulte as taxas e prazos diretamente conosco pelo WhatsApp."
    },
    {
    ...
    {
      question: "Quando a impressora travar eu puxo a folha?",
      answer: "Solicitamos que não, porém se for o caso, sempre retire primeiramente a impressora da tomada para realizar o procedimento, e evite forçar para não deslocar o kit de tração."
    }
  ];
